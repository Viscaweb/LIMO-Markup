...
// ***** Development tasks ****** //
module.exports = function (gulp, config, mdlPath) {
    const uniffe = require(mdlPath('utils/uniffe.js'));
    const pkg = require(mdlPath('package.json'));
    ...
    const SOURCES = [
        // Component handler
        mdlPath('src/mdlComponentHandler.js'),
        // Polyfills/dependencies
        mdlPath('src/third_party/**/*.js'),
        // Base components
        mdlPath('src/button/button.js'),
        mdlPath('src/checkbox/checkbox.js'),
        mdlPath('src/icon-toggle/icon-toggle.js'),
        mdlPath('src/menu/menu.js'),
        mdlPath('src/progress/progress.js'),
        mdlPath('src/radio/radio.js'),
        mdlPath('src/slider/slider.js'),
        mdlPath('src/snackbar/snackbar.js'),
        mdlPath('src/spinner/spinner.js'),
        mdlPath('src/switch/switch.js'),
        mdlPath('src/tabs/tabs.js'),
        mdlPath('src/textfield/textfield.js'),
        mdlPath('src/tooltip/tooltip.js'),
        // Complex components (which reuse base components)
        mdlPath('src/layout/layout.js'),
        mdlPath('src/data-table/data-table.js'),
        // And finally, the ripples
        mdlPath('src/ripple/ripple.js')
    ];
...
// Compile and Automatically Prefix Stylesheets (production)
    gulp.task('styles', () => {
        // For best performance, don't add Sass partials to `gulp.src`
        return gulp.src(config.srcPath + 'livescore.sass')
            // Generate Source Maps
            .pipe($.sourcemaps.init())
            .pipe($.sass({
                precision: 10,
...
// ***** Landing page tasks ***** //
    ...
    gulp.task('assets', () => {
        return gulp.src([
            mdlPath('docs/_assets/**/*'),
            mdlPath('node_modules/clippy/build/clippy.swf'),
            mdlPath('node_modules/swfobject-npm/swfobject/src/swfobject.js'),
            mdlPath('node_modules/prismjs/prism.js'),
            mdlPath('node_modules/prismjs/components/prism-markup.min.js'),
            mdlPath('node_modules/prismjs/components/prism-javascript.min.js'),
            mdlPath('node_modules/prismjs/components/prism-css.min.js'),
            mdlPath('node_modules/prismjs/components/prism-bash.min.js'),
            mdlPath('node_modules/prismjs/dist/prism-default/prism-default.css')
        ])
...
// built version of the MDL libraries.
    ...
    gulp.task('styles:gen', ['styles'], () => {
        const MaterialCustomizer = require(mdlPath('docs/_assets/customizer.js'));
